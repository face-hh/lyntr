...
import { Client, GatewayIntentBits, TextChannel, ActionRowBuilder, ButtonBuilder, ButtonStyle, EmbedBuilder } from 'discord.js';
...
async function createReportEmbed(text: string, reportedLynt: LyntInfo, reportedUser: UserInfo, reporter: UserInfo) {
    ...
    const embed = new EmbedBuilder()
        ...
        .addFields(
            { name: 'Reported User', value: `${reportedUser.username} (@${reportedUser.handle})`, inline: true },
