...
let questions: Question[] = [
    ...
    { id: 'ContentCreators', condition: (input: any) => { return Math.floor(-1 * Math.min(parseInt(input), 47) * 1.5) } },
    ...
    { id: 'TypingTest', condition: (input: any) => { return Math.floor(Math.min(parseInt(input), 120) / 0.25) } },
